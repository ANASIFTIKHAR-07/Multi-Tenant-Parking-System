      ...
      <Modal isOpen={modal === 'create'} onClose={() => setModal(null)} title="Assign Parking" size="large">
        <form onSubmit={handleCreate} className="space-y-5">
                  ...
                  <button
                    ...
                    className={`flex items-center gap-3 px-4 py-3 rounded-xl border text-left transition-all ${
                      selectedVehiclePlate === v.car_plate_number
                        ? 'border-blue-500 bg-blue-50 dark:bg-blue-500/10 ring-2 ring-blue-500/10'
          ...
          {form.parking_type === 'ASSIGNED' && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 rounded-xl bg-blue-50 dark:bg-blue-500/10 border border-blue-100 dark:border-blue-500/20">
